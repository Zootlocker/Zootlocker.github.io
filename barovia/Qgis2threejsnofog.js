...
(function () {
  ...
  app.init = function (container) {
    ...
    app.renderer.setSize(app.width, app.height*0.95);
    app.renderer.setClearColor(bgcolor || 0, (bgcolor === null) ? 0 : 1);
    app.container.appendChild(app.renderer.domElement);

    // scene
    app.scene = new THREE.Scene();
	//app.scene.fog = new THREE.Fog(0xb7b7b7, 2, 75);
  ...
  app.setCanvasSize = function (width, height) {
    ...
    app.renderer.setSize(width, height*0.95);
  };
  ...
  app.buildDefaultCamera = function () {
    ...
    app.camera.position.set(38.41441930597037, -9.648863788012987, 8.247432974306664);
	app.camera.lookAt(12.906088275539425, 6.256930400866917, -5.934012421586049);
	//app.camera.position.z = 100;
	//app.camera.position.set(90, -50, 30);
  };
